...
# Build-time LSan-off hook (§6.1, mayhem/lsan_off.c) — replaces a forbidden runtime
# __asan_default_options() override; ASan use-after-free/overflow + UBSan stay fully on/halting.
